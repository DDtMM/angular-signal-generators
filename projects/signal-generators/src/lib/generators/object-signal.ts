...
type BoundMethods<T, K extends MethodKeys<T> | UpdaterKeys<T> | null | undefined> =
  K extends MethodKeys<T> | UpdaterKeys<T> ? BoundMethodsStrict<T, K> : Record<string, never>;

export function objectSignal<T, const M extends MethodKeys<T>, const U extends UpdaterKeys<T>>(
